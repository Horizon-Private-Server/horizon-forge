...
enum ReactorParameters
{
	/* REACTOR_ACTION_SWING */
	REACTOR_PARAM_SWING_DAMAGE_MULTIPLIER = 0,
	REACTOR_PARAM_SWING_ATTACK_SPEED_MULTIPLIER = 1,
	REACTOR_PARAM_SWING_LUNGE_MULTIPLIER = 2,

	/* REACTOR_ACTION_CHARGE */
	REACTOR_PARAM_CHARGE_DAMAGE_MULTIPLIER = 3,
	REACTOR_PARAM_CHARGE_SPEED = 4,

	/* REACTOR_ACTION_SHOT_WITH_TRAIL */
	REACTOR_PARAM_SHOT_WITH_TRAIL_DAMAGE_MULTIPLIER = 5,
	REACTOR_PARAM_SHOT_WITH_TRAIL_PROJECTILE_SPEED = 6,

	/* REACTOR_ACTION_SMASH */
	REACTOR_PARAM_SMASH_DAMAGE_MULTIPLIER = 7,
	REACTOR_PARAM_SMASH_RADIUS = 8,
};
...
typedef struct ReactorMobVars
{
	...
	u32 ActionQueuedForTicks[REACTOR_ACTION_COUNT];
} ReactorMobVars_t;
