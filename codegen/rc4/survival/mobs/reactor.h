...
#define REACTOR_SMASH_MAX_DIST (15)
...
#define REACTOR_SWING_ATTACK_ANIM_LUNGE_DURATION (16)
...
#define REACTOR_STATE_COOLDOWN_TICKS (30)
...
enum ReactorStates
{
	...
	REACTOR_STATE_JUMP,
	REACTOR_STATE_WALK,
	REACTOR_STATE_FLINCH,
	REACTOR_STATE_BIG_FLINCH,
	REACTOR_STATE_LOOK_AT_TARGET,
	REACTOR_STATE_DIE,
	REACTOR_STATE_ATTACK_SWING,
	REACTOR_STATE_ATTACK_CHARGE,
	REACTOR_STATE_ATTACK_SHOT_WITH_TRAIL,
	REACTOR_STATE_ATTACK_SMASH,
	REACTOR_STATE_GLOAT,
};
...
enum ReactorActions
{
	REACTOR_ACTION_SWING,
	REACTOR_ACTION_CHARGE,
	REACTOR_ACTION_SHOT_WITH_TRAIL,
	REACTOR_ACTION_SMASH,
	REACTOR_ACTION_COUNT
};

enum ReactorActionParameters
{
	/* REACTOR_ACTION_SWING */
	REACTOR_ACTION_SWING_PARAM_DAMAGE_MULTIPLIER = 0,
	REACTOR_ACTION_SWING_PARAM_ATTACK_SPEED_MULTIPLIER = 1,
	REACTOR_ACTION_SWING_PARAM_LUNGE_MULTIPLIER = 2,

	/* REACTOR_ACTION_CHARGE */
	REACTOR_ACTION_CHARGE_PARAM_DAMAGE_MULTIPLIER = 0,
	REACTOR_ACTION_CHARGE_PARAM_SPEED_MULTIPLIER = 1,

	/* REACTOR_ACTION_SHOT_WITH_TRAIL */
	REACTOR_ACTION_SHOT_WITH_TRAIL_PARAM_DAMAGE_MULTIPLIER = 0,
	REACTOR_ACTION_SHOT_WITH_TRAIL_PARAM_PROJECTILE_SPEED = 1,

	/* REACTOR_ACTION_SMASH */
	REACTOR_ACTION_SMASH_PARAM_DAMAGE_MULTIPLIER = 0,
	REACTOR_ACTION_SMASH_PARAM_RADIUS = 1,
};
...
typedef struct ReactorMobVars
{
	...
	u32 ActionCooldownTicks[REACTOR_ACTION_COUNT];
	int ActionQueuedForTicks[REACTOR_ACTION_COUNT];
} ReactorMobVars_t;
