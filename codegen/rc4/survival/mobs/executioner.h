...
enum ExecutionerParameters
{
	/* EXECUTIONER_ACTION_MELEE */
	EXECUTIONER_PARAM_MELEE_DAMAGE_MULTIPLIER = 0,
	EXECUTIONER_PARAM_MELEE_ATTACK_SPEED_MULTIPLIER = 1,

	/* EXECUTIONER_ACTION_FIRE */
	EXECUTIONER_PARAM_FIRE_DAMAGE_MULTIPLIER = 2,
	EXECUTIONER_PARAM_FIRE_PROJECTILE_SPEED = 3,
};
...
typedef struct ExecutionerMobVars
{
	...
	u32 ActionQueuedForTicks[EXECUTIONER_ACTION_COUNT];
