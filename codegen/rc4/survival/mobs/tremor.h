...
enum TremorActionParameters
{
	/* TREMOR_ACTION_MELEE */
	TREMOR_ACTION_MELEE_PARAM_DAMAGE_MULTIPLIER = 0,
	TREMOR_ACTION_MELEE_PARAM_ATTACK_SPEED_MULTIPLIER = 1,
	TREMOR_ACTION_MELEE_PARAM_LUNGE_MULTIPLIER = 2,

	/* TREMOR_ACTION_GROUND_QUAKE */
	TREMOR_ACTION_GROUND_QUAKE_PARAM_DAMAGE_MULTIPLIER = 0,
	TREMOR_ACTION_GROUND_QUAKE_PARAM_QUAKE_SPEED_MULTIPLIER = 1,
};
