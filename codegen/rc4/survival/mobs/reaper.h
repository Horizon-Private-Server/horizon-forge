...
enum ReaperParameters
{
	/* REAPER_ACTION_MELEE */
	REAPER_PARAM_MELEE_DAMAGE_MULTIPLIER = 0,
	REAPER_PARAM_MELEE_ATTACK_SPEED_MULTIPLIER = 1,
	REAPER_PARAM_MELEE_LUNGE_MULTIPLIER = 2,
	REAPER_PARAM_MELEE_AGGRO_DAMAGE_MULTIPLIER = 3,
	REAPER_PARAM_MELEE_AGGRO_MOVE_SPEED_MULTIPLIER = 4,
};
...
typedef struct ReaperMobVars
{
	...
	u32 ActionQueuedForTicks[REAPER_ACTION_COUNT];
} ReaperMobVars_t;
