...
#define REAPER_TURN_LUNGE_RADIANS_PER_SEC (15 * MATH_DEG2RAD)
...
#define REAPER_ATTACK_ANIM_LUNGE_DURATION (10)
...
#define REAPER_KNOCKBACK_MULTIPLIER (1.0)
#define REAPER_STATE_COOLDOWN_TICKS (30)
...
enum ReaperStates
{
	...
	REAPER_STATE_AGGRO,
	REAPER_STATE_FLINCH,
	REAPER_STATE_BIG_FLINCH,
	REAPER_STATE_LOOK_AT_TARGET,
	REAPER_STATE_DIE,
	REAPER_STATE_ATTACK,
};
...
enum ReaperActionParameters
{
	/* REAPER_ACTION_MELEE */
	REAPER_ACTION_MELEE_PARAM_DAMAGE_MULTIPLIER = 0,
	REAPER_ACTION_MELEE_PARAM_ATTACK_SPEED_MULTIPLIER = 1,
	REAPER_ACTION_MELEE_PARAM_LUNGE_MULTIPLIER = 2,
	REAPER_ACTION_MELEE_PARAM_AGGRO_DAMAGE_MULTIPLIER = 3,
	REAPER_ACTION_MELEE_PARAM_AGGRO_MOVE_SPEED_MULTIPLIER = 4,
};
...
typedef struct ReaperMobVars
{
	...
	char AggroTriggered;
	u32 ActionCooldownTicks[REAPER_ACTION_COUNT];
	int ActionQueuedForTicks[REAPER_ACTION_COUNT];
} ReaperMobVars_t;
